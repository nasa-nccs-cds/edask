...
```
    ...
    > conda install -c conda-forge libnetcdf nco eofs dask distributed xarray matplotlib scipy dateparser bottleneck paramiko netCDF4 defusedxml python-graphviz bokeh pyparsing pillow scikit-learn tensorflow keras zeromq pyzmq pytest cartopy paramiko
