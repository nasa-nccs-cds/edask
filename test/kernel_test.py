...
if __name__ == '__main__':
    ...
    try:
        ...
        aveTask = WorkflowNode("xarray.ave", domain, ['tas'], "result", {"axes": "xyt"})
        inputTask = WorkflowNode("xarray.input", domain, ['tas'], "result", {"file": '/Users/tpmaxwel/Dropbox/Tom/Data/GISS/CMIP5/E2H/r1i1p1/*.nc'})
