...
class ParameterManager:
    ...
    def __init__(self):
        ...
        self.TRANSIENTS_DIR = self._parms.get("edas.transients.dir", os.path.expanduser("~/.edas/conf"))
        self.COLLECTIONS_DIR = self._parms.get("edas.coll.dir", self.TRANSIENTS_DIR)
